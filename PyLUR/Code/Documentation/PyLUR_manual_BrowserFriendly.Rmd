...
6. Click Open another project, browse to the PyLUR.aprx and double-click to open it. In the Catalog window double-click Toolboxes, then double-click PyLUR.tbx. This will open the PyLUR toolbox, which contains the BuildLUR and ApplyLUR scripts. Running either of these script will open the Build LUR or Apply LUR wizard, respectively.
...
1. Download ExampleData.gdb.zip from the PyLUR repository on GitHub and unzip the ExampleData.gdb file geodatabase.
...
1. Start ArcGIS Pro and open the PyLUR project.
2. In the Catalog window right-click Folders and click Add Folder Connection. Create a connection to the directory in which the ExampleData.gdb file geodatabase has been saved.  
